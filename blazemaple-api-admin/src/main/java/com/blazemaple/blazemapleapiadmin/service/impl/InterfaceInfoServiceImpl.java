...
import com.blazemaple.blazemapleapiadmin.mapper.InterfaceInfoMapper;
...
import com.blazemaple.blazemapleapicommon.model.vo.RequestParamsRemarkVO;
import com.blazemaple.blazemapleapicommon.model.vo.ResponseParamsRemarkVO;
...
public class InterfaceInfoServiceImpl extends ServiceImpl<InterfaceInfoMapper, InterfaceInfo>
    ...
    @Override
    public BlazeMapleApiClient getBlazeMapleApiClient(HttpServletRequest request) {
        // 获取当前登录用户
        User loginUser = userService.getLoginUser(request);
