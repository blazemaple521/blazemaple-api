...
import com.blazemaple.blazemapleapiadmin.config.GatewayConfig;
import com.blazemaple.blazemapleapiadmin.exception.BusinessException;
import com.blazemaple.blazemapleapiadmin.exception.ThrowUtils;
...
import com.blazemaple.blazemapleapicommon.common.*;
import com.blazemaple.blazemapleapicommon.constant.CommonConstant;
import com.blazemaple.blazemapleapicommon.constant.UserConstant;
import com.blazemaple.blazemapleapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.blazemaple.blazemapleapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
...
import com.blazemaple.blazemapleapicommon.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        BlazeMapleApiClient blazeMapleApiClient = interfaceInfoService.getBlazeMapleApiClient(request);
        // 设置网关地址
        blazeMapleApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = blazeMapleApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = blazeMapleApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
