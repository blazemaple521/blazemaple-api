...
import com.blazemaple.blazemapleapicommon.common.DeleteRequest;
...
import com.blazemaple.blazemapleapicommon.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.blazemaple.blazemapleapicommon.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.blazemaple.blazemapleapicommon.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    @PostMapping("/apply")
    public BaseResponse<Long> userGetInterfaceInfo(@RequestBody UserInterfaceInfoAddRequest userInterfaceInfoAddRequest, HttpServletRequest request) {
        if (userInterfaceInfoAddRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        UserInterfaceInfo userInterfaceInfo = new UserInterfaceInfo();
