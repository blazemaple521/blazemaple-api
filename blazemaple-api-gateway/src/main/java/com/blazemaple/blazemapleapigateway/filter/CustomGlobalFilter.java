package com.blazemaple.blazemapleapigateway.filter;
...
import com.blazemaple.blazemapleapicommon.service.InnerUserInterfaceInfoService;
import com.blazemaple.blazemapleapicommon.service.InnerUserService;
import com.blazemaple.blazemapleapigateway.exception.BusinessException;
import com.blazemaple.blazemapleclientsdk.utils.SignUtils;
...
public class CustomGlobalFilter implements GlobalFilter, Ordered {
    ...
    public static final List<String> IP_WHITE_LIST = Arrays.asList("127.0.0.1","172.26.28.37");
    private static final String DYE_DATA_HEADER = "X-Dye-Data";
    private static final String DYE_DATA_VALUE = "blazemaple";
