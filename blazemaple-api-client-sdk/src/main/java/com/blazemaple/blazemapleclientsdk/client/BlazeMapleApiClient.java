package com.blazemaple.blazemapleclientsdk.client;
...
import static com.blazemaple.blazemapleclientsdk.utils.SignUtils.genSign;

/**
 * API 调用
 */
public class BlazeMapleApiClient {
    ...
    public BlazeMapleApiClient(String accessKey, String secretKey) {
